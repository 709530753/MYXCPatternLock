#
#  Be sure to run `pod spec lint SLMPatternLock.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name         = "SLMPatternLock"
  s.version      = "0.0.1"
  s.summary      = "A short description of SLMPatternLock."
  ...
  s.source_files  = "SLMPatternLock", "SLMPatternLock/**/*.{h,m}"
